...
import { Mail, Lock, ArrowRight, Loader2, Sun, Moon, ArrowLeft, Eye, EyeOff } from "lucide-react";
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <Link
                ...
                className="text-[9px] uppercase font-bold tracking-wider text-indigo-400/80 hover:text-indigo-300 transition-all underline"
              >
                Forgot Password?
              </Link>
            </div>
